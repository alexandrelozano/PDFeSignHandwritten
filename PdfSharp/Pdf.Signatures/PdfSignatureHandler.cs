...
namespace PdfSharp.Pdf.Signatures
{
    ...
    public class PdfSignatureHandler
    {
        ...
        public void AttachToDocument(PdfDocument documentToSign, int Page)
        {            
        ...
        private void AddSignatureComponents(object sender, EventArgs e)
        {
            ...
            if (!Document.Pages[Page].Elements.ContainsKey(PdfPage.Keys.Annots))
                Document.Pages[Page].Elements.Add(PdfPage.Keys.Annots, new PdfArray(Document));

            (Document.Pages[Page].Elements[PdfPage.Keys.Annots] as PdfArray).Elements.Add(signature);
